    ...
    <div className="pointer-events-none absolute inset-0 z-[5] overflow-hidden">
      {pieces.map((piece) => (
        <motion.div
          ...
          transition={{
            duration: mobile ? piece.duration * 1.25 : piece.duration,
            delay: piece.delay,
            repeat: Infinity,
            ease: "linear",
          }}
      ...
      <main className="relative z-10">
        <section className="relative flex min-h-[124vh] items-center overflow-hidden bg-[#0a1580] sm:min-h-[128vh] md:min-h-[132vh] lg:min-h-[150vh] xl:min-h-[152vh] 2xl:min-h-[156vh]">
          ...
          <img
            ...
            alt=""
            aria-hidden="true"
            className="pointer-events-none absolute left-1/2 top-[24%] z-[8] w-[460px] -translate-x-1/2 object-contain sm:w-[560px] md:w-[760px] lg:top-[13%] lg:w-[620px] xl:top-[11%] xl:w-[700px] 2xl:top-[10%] 2xl:w-[760px]"
            style={{
              filter:
