...
<img
  ...
  alt=""
  aria-hidden="true"
  className="pointer-events-none absolute left-[-8%] top-[24%] z-[8] w-[1100px] object-contain sm:left-[-6%] sm:top-[24%] sm:w-[1200px] md:left-[-4%] md:top-[25%] md:w-[1300px] lg:left-[-2%] lg:top-[25%] lg:w-[1400px]"
  style={{
    filter:
