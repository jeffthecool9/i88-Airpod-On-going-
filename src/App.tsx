    ...
    <div className="pointer-events-none absolute inset-0 z-[5] overflow-hidden">
      {pieces.map((piece) => (
        <motion.div
          ...
          transition={{
            duration: mobile ? piece.duration * 1.2 : piece.duration,
            delay: piece.delay,
            repeat: Infinity,
            ease: "linear",
          }}
...
const RealisticBackground = ({ mobile = false }: { mobile?: boolean }) => (
  <div className="pointer-events-none absolute inset-0 z-0 flex items-center justify-center overflow-hidden">
    ...
    {mobile ? (
      <>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_35%,rgba(125,211,252,0.20),transparent_35%)]" />
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.04),transparent_22%,transparent_70%,rgba(0,0,0,0.08))]" />
      </>
    ) : (
      <>
        ...
        <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/white-diamond.png')] opacity-15 mix-blend-overlay" />
      </>
    )}
  </div>
);
...
const SectionSeam = ({
  ...
  <div
    className={`pointer-events-none absolute left-0 z-20 w-full overflow-hidden leading-[0] ${className}`}
  >
    <svg
      viewBox="0 0 1200 120"
      preserveAspectRatio="none"
      className="block h-[76px] w-full sm:h-[120px]"
    >
      {shape === "dome" ? (
        <>
          <path
...
const RegistrationForm = () => {
  ...
  return (
    <section
      ...
      className="relative z-10 overflow-hidden bg-[radial-gradient(circle_at_12%_18%,rgba(34,211,238,0.16),transparent_24%),radial-gradient(circle_at_85%_22%,rgba(59,130,246,0.20),transparent_28%),radial-gradient(circle_at_50%_85%,rgba(56,189,248,0.08),transparent_30%),linear-gradient(180deg,#0B49B8_0%,#0A3D9D_35%,#082B78_72%,#03143E_100%)] px-6 py-24 sm:py-32"
    >
      <img
        src={i882Img}
        alt="i88"
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/white-diamond.png')] opacity-[0.05] mix-blend-screen" />
      </div>
    ...
    >
      ...
      >
        <motion.img
          ...
          animate={{ opacity: shouldShowGirl ? [0.45, 0.9, 0.45] : 0 }}
...
const TrackerCard = ({
  ...
  <div className="relative rounded-[22px] bg-[linear-gradient(135deg,#FFE8A3_0%,#F7C948_25%,#C88A14_60%,#FFE08A_100%)] p-[2px] shadow-[0_14px_32px_rgba(0,0,0,0.28)]">
    <div className="relative h-[82px] overflow-hidden rounded-[20px] bg-[linear-gradient(180deg,#0A2C83_0%,#0B3A9B_45%,#092A78_100%)] sm:h-[86px] md:h-[92px]">
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(8,28,84,0.26)_0%,rgba(6,21,70,0.58)_100%)]" />
      <div className="absolute inset-x-[8%] top-[3px] h-[28px] rounded-full bg-[linear-gradient(180deg,rgba(255,255,255,0.14),transparent)] blur-[1px]" />
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-3 text-center">
        <p
          className="text-[14px] font-black uppercase leading-[0.95] text-[#FFF4C8] sm:text-[16px] md:text-[18px]"
          style={{
            letterSpacing: "-0.03em",
            textShadow:
              "0 1px 0 rgba(255,255,255,0.48), 0 2px 0 rgba(255,215,106,0.14), 0 8px 20px rgba(0,0,0,0.38)",
          }}
        >
          {title}
        </p>
        {sub ? (
          <p
            className="mt-2 text-center text-[11px] font-bold leading-[1.08] text-[#FFD76A] sm:text-[12px] md:text-[13px]"
...
const StepsToClaim = ({
  ...
  stepData: { title: string; desc: string; image: string }[];
}) => {
  return (
    <section
      id="steps-to-claim"
      className="relative overflow-hidden bg-[linear-gradient(180deg,#144FB9_0%,#0C3E9B_50%,#07276D_100%)] px-4 pt-16 pb-20 sm:px-6 md:px-8"
    >
...
const trackerFillWidth =
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-brand-navy/70 font-sans text-slate-200 selection:bg-blue-500/30">
      ...
      {!isMobile && (
        <div className="pointer-events-none fixed inset-0 z-[100] bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-[0.03] mix-blend-overlay" />
      )}
      ...
      <main className="relative z-10">
        <section className="relative flex min-h-[124vh] items-center overflow-hidden bg-[#0a1580] sm:min-h-[128vh] md:min-h-[132vh] lg:min-h-[150vh] xl:min-h-[152vh] 2xl:min-h-[156vh]">
          ...
          <img
            ...
            className="pointer-events-none absolute left-1/2 top-[140px] z-[10] w-[320px] -translate-x-1/2 object-contain sm:top-[150px] sm:w-[360px] md:top-[72px] md:w-[340px] lg:top-[54px] lg:w-[430px] xl:top-[56px] xl:w-[500px]"
          />
          ...
          <img
            ...
            alt=""
            aria-hidden="true"
            className="pointer-events-none absolute left-1/2 top-[24%] z-[8] w-[520px] -translate-x-1/2 object-contain sm:w-[620px] md:w-[760px] lg:top-[13%] lg:w-[620px] xl:top-[11%] xl:w-[700px] 2xl:top-[10%] 2xl:w-[760px]"
            style={{
              filter:
  ...
  <div className="absolute inset-0 flex flex-col items-center justify-center px-5 text-center sm:px-7 md:px-8">
    <img
      src={heroTopTextImg}
      alt="Your AirPods Awaits"
      className="relative z-10 w-[88%] max-w-[340px] object-contain sm:max-w-[390px] md:max-w-[430px] lg:max-w-[500px]"
    />

    <img
      src={heroFinalTextImg}
      alt="Complete the final 1%"
      className="relative z-10 mt-1 w-[92%] max-w-[350px] object-contain sm:max-w-[400px] md:max-w-[440px] lg:max-w-[510px]"
    />
  </div>
</div>
          ...
          <motion.div
            ...
            animate={{ y: [0, 5, 0], opacity: [0.16, 0.3, 0.16] }}
  ...
  <div className="mx-auto max-w-5xl">
    {/* progress bar */}
    <div className="relative mx-auto mb-5 h-[10px] w-[86%] overflow-hidden rounded-full bg-white/10 shadow-[inset_0_2px_8px_rgba(0,0,0,0.22)] sm:h-[12px]">
      <motion.div
        className="h-full rounded-full bg-[linear-gradient(90deg,#FFE08A_0%,#F7C948_35%,#D89A18_72%,#B9780C_100%)] shadow-[0_0_18px_rgba(255,215,106,0.28)]"
        animate={{ width: trackerFillWidth }}
        transition={{ duration: 0.45, ease: "easeOut" }}
      />
    </div>

    <div className="grid grid-cols-4 items-end gap-3 sm:gap-4 lg:gap-6 xl:gap-8 2xl:gap-10">
      {trackerItems.map((item, i) => {
        ...
        return (
          <motion.div
            ...
            animate={
              isReached
                ...
                : { opacity: 0.78, y: 6, scale: 0.98 }
            }
            transition={{ duration: 0.4, ease: "easeOut" }}
          >
            <TrackerCard title={item.title} sub={item.sub} />
          </motion.div>
        );
      })}
    </div>
          ...
          <div className="pointer-events-none absolute bottom-[118px] left-1/2 z-[8] w-full max-w-[980px] -translate-x-1/2 px-4 sm:bottom-[122px] sm:px-6 md:bottom-[126px] lg:bottom-[88px] lg:px-8 xl:bottom-[84px]">
  <div className="relative mx-auto max-w-[860px]">
    ...
    <div className="relative z-[3] grid grid-cols-1 gap-3 sm:grid-cols-3 sm:gap-5 lg:gap-6">
      <TrustCard>
        Trusted Since
        <br />
        <span className="text-[18px] sm:text-[20px] md:text-[22px]">2016</span>
      </TrustCard>

      <TrustCard>
        5,000+ Active
        <br />
        <span className="text-[18px] sm:text-[20px] md:text-[22px]">Members</span>
      </TrustCard>

      <TrustCard>
        10+ Rewards
        <br />
        <span className="text-[18px] sm:text-[20px] md:text-[22px]">To Unlock</span>
      </TrustCard>
    </div>
  </div>
</div>
        ...
        <StepsToClaim stepData={stepData} />
        <RegistrationForm />
        <FloatingGirl />
      </main>
    </div>
